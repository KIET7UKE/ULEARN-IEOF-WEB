  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-16 pb-12 sm:pt-20 sm:pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <ScrollAnimation className="space-y-5">
            <Badge variant="secondary" className="px-3 py-1 text-sm whitespace-normal text-pretty">
              International English Olympiad Foundation (IEOF)
            </Badge>
            <h1 className="text-5xl lg:text-6xl font-bold tracking-tight text-foreground">GEO</h1>
            <p className="text-lg lg:text-xl font-semibold text-foreground">GEO: Gateway to Global Recognition</p>
            <p className="text-base lg:text-lg text-muted-foreground max-w-3xl mx-auto text-pretty">
              The Global English Olympiad (GEO) is <strong>India’s first offline</strong>, international‑standard
              English competition for Grades 1–10, in collaboration with Edufam International Academy, Dubai.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              India's first offline, international-standard English competition organized by IEOF in collaboration with
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Certificates and awards recognized globally, enhancing students' academic profiles.",
              },
              {
                icon: Target,
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation className="text-center space-y-3 mb-10">
            ...
            <p className="text-muted-foreground">Rolling counters animate when this section enters view</p>
          </ScrollAnimation>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <Counter to={50000} suffix="+" className="text-4xl font-extrabold text-foreground" />
              <p className="mt-1 text-sm text-muted-foreground">Students Reached</p>
            </div>
            <div>
              <Counter to={10} className="text-4xl font-extrabold text-foreground" />
              <p className="mt-1 text-sm text-muted-foreground">Grades (1–10)</p>
            </div>
            <div>
              <Counter to={3} className="text-4xl font-extrabold text-foreground" />
              <p className="mt-1 text-sm text-muted-foreground">Competition Levels</p>
            </div>
            <div>
              <Counter to={7} className="text-4xl font-extrabold text-foreground" />
              <p className="mt-1 text-sm text-muted-foreground">Singapore Toppers (Grades 4–10)</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation className="text-center space-y-4 mb-10">
            ...
            <p className="text-muted-foreground max-w-3xl mx-auto">
              Gateway to Global Recognition — build English excellence and unlock international exposure.
            </p>
          </ScrollAnimation>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Globe, title: "Global Platform", desc: "Truly international competition and recognition." },
              { icon: Target, title: "English Excellence", desc: "Grammar, vocabulary, comprehension, and oracy." },
              { icon: Trophy, title: "Rewards & Awards", desc: "Cash prizes, certificates, medals, Singapore trip." },
              { icon: Users, title: "Every Child Valued", desc: "From participation to international awards." },
            ].map((f, i) => (
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation className="text-center space-y-2 mb-8">
            <h3 className="text-2xl lg:text-3xl font-bold">Our Lead Partners</h3>
            <p className="text-muted-foreground">In collaboration with Edufam International Academy, Dubai</p>
          </ScrollAnimation>
          <MarqueeLogos
            logos={[
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation className="text-center space-y-4 mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-foreground text-balance">Competition Structure</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              A three-stage journey to recognize English excellence—ending with international recognition in Singapore.
            </p>
          </ScrollAnimation>
            ...
            {[
              {
                ...
                description: "Conducted at school level; top performers qualify for regional round.",
                icon: BookOpen,
                color: "bg-blue-500",
              },
              {
                ...
                description: "Conducted at regional centers; qualifiers move to national recognition.",
                icon: Users,
                color: "bg-green-500",
              },
              {
                ...
                description: "Winners are flown to Singapore for international felicitation and experiences.",
                icon: Plane,
                color: "bg-primary",
              },
            ].map((stage, index) => (
              ...
              >
                <Card className="h-full relative overflow-hidden hover:shadow-xl transition-all duration-300">
                  ...
                  <CardHeader>
                    ...
                    <CardDescription className="text-primary font-semibold">{stage.date}</CardDescription>
                  </CardHeader>
                  <CardContent>
          ...
          <ScrollAnimation className="mt-8 text-center">
            <p className="text-sm text-muted-foreground">
              Note: The Singapore trip is 100% sponsored by IEOF – covering travel, stay, meals, and activities.
            </p>
          </ScrollAnimation>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-secondary/5 to-primary/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              Every participant is a winner, but top achievers receive life-changing rewards and international exposure.
            </p>
          </ScrollAnimation>
              ...
              <Card className="h-full bg-gradient-to-br from-primary/10 to-secondary/10 border-primary/20">
                <CardHeader>
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      <CardTitle className="text-2xl">Grades 1-3 Winners</CardTitle>
                ...
                <CardContent className="space-y-4">
                  ...
                  <p className="text-lg text-muted-foreground">Cash Prize + Certificate + Medal</p>
              ...
              <Card className="h-full bg-gradient-to-br from-secondary/10 to-primary/10 border-secondary/20">
                <CardHeader>
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      <CardTitle className="text-2xl">Grades 4-10 Winners</CardTitle>
                      <CardDescription>International Experience</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="text-2xl font-bold text-secondary">Singapore Trip</div>
            ...
            <Card className="max-w-2xl mx-auto bg-card/50 backdrop-blur-sm">
              <CardContent className="pt-6 space-y-3">
                <div className="flex items-center justify-center space-x-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-foreground">Every Student Wins</h3>
                  <Star className="w-8 h-8 text-primary" />
                </div>
                <p className="text-lg text-muted-foreground mb-6">
                  All participants receive a Certificate of Participation, recognizing their effort and encouraging
                  continued English excellence.
                </p>
      ...
      <section className="py-20 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation className="text-center space-y-4 mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-foreground text-balance">Singapore Journey Timeline</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
              Follow the journey of the Global English Olympiad from registration to the grand finale in Singapore.
            </p>
          </ScrollAnimation>
      ...
      <section className="py-20 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimation className="text-center space-y-4 mb-12">
            ...
            <p className="text-muted-foreground">What parents and students say about GEO</p>
          </ScrollAnimation>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollAnimation className="space-y-8">
            ...
            <p className="text-xl text-primary-foreground/90 text-pretty">
              Register now for just ₹299 and give your child the opportunity to compete on a global stage and win a
              life‑changing trip to Singapore.
            </p>
